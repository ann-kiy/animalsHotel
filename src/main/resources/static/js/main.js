...
//         '    <div class="col-md-4">\n' +
//         '      <img v-bind:src="\'/img/\'+message.author.img" class="card-img" alt="...">\n' +
//         '    </div>\n' +
//         '    <div class="col-md-8">\n' +
//         '      <div class="card-body">\n' +
//         '        <h5 class="card-title">{{message.author.name}}</h5>\n' +
//         '        <p class="card-text">{{message.text}}</p>\n' +
//         '        <p class="card-text"><small class="text-muted">{{message.createDate}}</small></p>\n' +
...
//     el: '#app',
//     template:
//     '        <div class="card mb-3" style="min-width: 1000px; max-hieght:30px">' +
//         '            <div class="row no-gutters">' +
//         '                <div class="col-md-5">' +
